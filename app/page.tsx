    ...
    <div className="min-h-screen bg-zinc-900 text-white">
      ...
      {featuredMovie && (
        <div className="relative h-[56.25vw] max-h-[80vh] w-full">
          <Image
            src={getImageUrl(featuredMovie.coverUrl)} // <--- Usando o helper
          ...
          <div className="absolute bottom-[20%] left-4 md:left-16 max-w-xl p-4 space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold drop-shadow-xl">{featuredMovie.title}</h1>
            <p className="text-white text-sm md:text-lg drop-shadow-md line-clamp-3">
              {featuredMovie.description || "Assista agora."}
            </p>
      ...
      <div className="pb-40 px-4 md:px-16 -mt-20 relative z-10">
        <h2 className="text-white text-xl md:text-2xl font-semibold mb-4">Minha Lista</h2>
